...
def run():
    ...
    data = sc.textFile(r"D:\java\idea\a2019\sparklearn\data\小王子.txt")   #读取是utf-8编码的文件
    with open(r'D:\java\idea\a2019\sparklearn\data\stopwords-master\百度停用词表.txt','r',encoding='utf-8') as f:
        x=f.readlines()
    stop=[i.replace('\n','') for i in x]
